...
if uploaded_file is not None:
  ...
  image1=imread('/content/drive/MyDrive/2024/Major Project_G15_CVD_ECG/ECG Images of Patient that have History of MI (172x12=2064)/PMI(10).jpg')
  image1 = color.rgb2gray(image1)
  image1=resize(image1,(1572,2213))

  image2=imread('/content/drive/MyDrive/2024/Major Project_G15_CVD_ECG/ECG Images of Patient that have abnormal heartbeat (233x12=2796)/HB(15).jpg')
  image2 = color.rgb2gray(image2)
  image2=resize(image2,(1572,2213))

  image3=imread('/content/drive/MyDrive/2024/Major Project_G15_CVD_ECG/Normal Person ECG Images (284x12=3408)/Normal(11).jpg')
  image3 = color.rgb2gray(image3)
  image3=resize(image2,(1572,2213))

  image4=imread('/content/drive/MyDrive/2024/Major Project_G15_CVD_ECG/ECG Images of Myocardial Infarction Patients (240x12=2880)/MI(1).jpg')
  ...
  if similarity_score > 0.70:
    ...
    loaded_model = joblib.load('/content/drive/MyDrive/2024/Major Project_G15_CVD_ECG/G15_CVD_Heart_Disease_Prediction_using_ECG.pkl')
    ...
    if result[0] == 3:
      st.write("You ECG corresponds to Patient History of Myocardial Infarction")
